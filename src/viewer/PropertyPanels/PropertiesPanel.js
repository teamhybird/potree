...
export class PropertiesPanel{
	...
	setPointCloud(pointcloud){
		...
		{
			let matcaps = [
				{name: "Normals", icon: `${resourcePath}/icons/matcap/check_normal+y.jpg`}, 
				{name: "Basic 1", icon: `${resourcePath}/icons/matcap/basic_1.jpg`}, 
				{name: "Basic 2", icon: `${resourcePath}/icons/matcap/basic_2.jpg`}, 
				{name: "Basic Dark", icon: `${resourcePath}/icons/matcap/basic_dark.jpg`}, 
				{name: "Basic Side", icon: `${resourcePath}/icons/matcap/basic_side.jpg`}, 
				{name: "Ceramic Dark", icon: `${resourcePath}/icons/matcap/ceramic_dark.jpg`}, 
				{name: "Ceramic Lightbulb", icon: `${resourcePath}/icons/matcap/ceramic_lightbulb.jpg`}, 
				{name: "Clay Brown", icon: `${resourcePath}/icons/matcap/clay_brown.jpg`}, 
				{name: "Clay Muddy", icon: `${resourcePath}/icons/matcap/clay_muddy.jpg`}, 
				{name: "Clay Studio", icon: `${resourcePath}/icons/matcap/clay_studio.jpg`}, 
				{name: "Resin", icon: `${resourcePath}/icons/matcap/resin.jpg`}, 
				{name: "Skin", icon: `${resourcePath}/icons/matcap/skin.jpg`}, 
				{name: "Jade", icon: `${resourcePath}/icons/matcap/jade.jpg`}, 
				{name: "Metal_ Anisotropic", icon: `${resourcePath}/icons/matcap/metal_anisotropic.jpg`}, 
				{name: "Metal Carpaint", icon: `${resourcePath}/icons/matcap/metal_carpaint.jpg`}, 
				{name: "Metal Lead", icon: `${resourcePath}/icons/matcap/metal_lead.jpg`}, 
				{name: "Metal Shiny", icon: `${resourcePath}/icons/matcap/metal_shiny.jpg`}, 
				{name: "Pearl", icon: `${resourcePath}/icons/matcap/pearl.jpg`}, 
				{name: "Toon", icon: `${resourcePath}/icons/matcap/toon.jpg`},
				{name: "Check Rim Light", icon: `${resourcePath}/icons/matcap/check_rim_light.jpg`}, 
				{name: "Check Rim Dark", icon: `${resourcePath}/icons/matcap/check_rim_dark.jpg`}, 
				{name: "Contours 1", icon: `${resourcePath}/icons/matcap/contours_1.jpg`}, 
				{name: "Contours 2", icon: `${resourcePath}/icons/matcap/contours_2.jpg`}, 
				{name: "Contours 3", icon: `${resourcePath}/icons/matcap/contours_3.jpg`}, 
				{name: "Reflection Check Horizontal", icon: `${resourcePath}/icons/matcap/reflection_check_horizontal.jpg`}, 
				{name: "Reflection Check Vertical", icon: `${resourcePath}/icons/matcap/reflection_check_vertical.jpg`}, 
			];
