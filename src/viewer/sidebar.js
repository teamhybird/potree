...
export class Sidebar {
  ...
  initToolbar() {
    ...
    // SHAPE CUBE
    elToolbar.append(
      this.createToolIcon(Potree.resourcePath + '/icons/box.svg', '[title]tt.shape_cube', () => {
    ...
    // SHAPE RING
    elToolbar.append(
      this.createToolIcon(Potree.resourcePath + '/icons/sphere.svg', '[title]tt.shape_ring', () => {
    ...
    // SHAPE CYLINDER
    elToolbar.append(
      this.createToolIcon(Potree.resourcePath + '/icons/cylinder.svg', '[title]tt.shape_cylinder', () => {
    ...
    // SHAPE SPHERE
    elToolbar.append(
      this.createToolIcon(Potree.resourcePath + '/icons/sphere.svg', '[title]tt.shape_sphere', () => {
    ...
    // COMPONENT
    elToolbar.append(
      this.createToolIcon(Potree.resourcePath + '/icons/point.svg', '[title]tt.point_component', () => {
        $('#menu_measurements').next().slideDown();
        let measurement = this.measuringTool.startInsertion({
          showDistances: false,
          showAngles: false,
    ...
    // COMPONENT
    elToolbar.append(
      this.createToolIcon(Potree.resourcePath + '/icons/point.svg', '[title]tt.point_defect', () => {
        $('#menu_measurements').next().slideDown();
        let measurement = this.measuringTool.startInsertion({
          showDistances: false,
          showAngles: false,
    ...
    // NOTIFICATION
    elToolbar.append(
      this.createToolIcon(Potree.resourcePath + '/icons/notification.svg', '[title]tt.point_notification', () => {
        $('#menu_measurements').next().slideDown();
        let measurement = this.measuringTool.startInsertion({
          showDistances: false,
          showAngles: false,
    ...
    elToolbar.append(
      this.createToolIcon(Potree.resourcePath + '/icons/rg_measurement_location.svg', '[title]tt.point_rg_measurement_location', () => {
        ...
        let measurement = this.measuringTool.startInsertion({
          ...
          systemType: SystemType.rgMeasurementLocation,
  ...
  initScene() {
    ...
    tree.on('dblclick', '.jstree-anchor', (e) => {
      ...
      if (object instanceof PointCloudTree) {
        ...
        let target = new THREE.Vector3().addVectors(position, object.getWorldDirection(new THREE.Vector3()).multiplyScalar(distance));
  ...
  initClippingTool() {
...

    {
      ...
      let currentClipTask = Object.keys(ClipTask).filter((key) => ClipTask[key] === this.viewer.clipTask);
...

    {
      ...
      let currentClipMethod = Object.keys(ClipMethod).filter((key) => ClipMethod[key] === this.viewer.clipMethod);
    ...
    clippingToolBar.append(
      this.createToolIcon(Potree.resourcePath + '/icons/clip_volume.svg', '[title]tt.clip_volume', () => {
    ...
    // CLIP POLYGON
    clippingToolBar.append(
      this.createToolIcon(Potree.resourcePath + '/icons/clip-polygon.svg', '[title]tt.clip_polygon', () => {
...

    {
      ...
      clippingToolBar.append(
        this.createToolIcon(Potree.resourcePath + '/icons/clip-screen.svg', '[title]tt.screen_clip_box', () => {
...

    {
      ...
      clippingToolBar.append(
        this.createToolIcon(Potree.resourcePath + '/icons/remove.svg', '[title]tt.remove_all_clipping_volumes', () => {
  ...
  initNavigation() {
    ...
    elNavigation.append(
      this.createToolIcon(Potree.resourcePath + '/icons/earth_controls_1.png', '[title]tt.earth_control', () => {
        this.viewer.setControls(this.viewer.earthControls);
      })
    );

    elNavigation.append(
      this.createToolIcon(Potree.resourcePath + '/icons/fps_controls.svg', '[title]tt.flight_control', () => {
    ...
    elNavigation.append(
      this.createToolIcon(Potree.resourcePath + '/icons/helicopter_controls.svg', '[title]tt.heli_control', () => {
        this.viewer.setControls(this.viewer.fpControls);
    ...
    elNavigation.append(
      this.createToolIcon(Potree.resourcePath + '/icons/orbit_controls.svg', '[title]tt.orbit_control', () => {
        this.viewer.setControls(this.viewer.orbitControls);
      })
    );

    elNavigation.append(
      this.createToolIcon(Potree.resourcePath + '/icons/focus.svg', '[title]tt.focus_control', () => {
        this.viewer.fitToScreen();
      })
    );

    elNavigation.append(
      this.createToolIcon(Potree.resourcePath + '/icons/navigation_cube.svg', '[title]tt.navigation_cube_control', () => {
        this.viewer.toggleNavigationCube();
      })
    );

    elNavigation.append(
      this.createToolIcon(Potree.resourcePath + '/images/compas.svg', '[title]tt.compass', () => {
    ...
    elNavigation.append(
      this.createToolIcon(Potree.resourcePath + '/icons/camera_animation.svg', '[title]tt.camera_animation', () => {
    ...
    elNavigation.append(
      this.createToolIcon(Potree.resourcePath + '/icons/left.svg', '[title]tt.left_view_control', () => {
        this.viewer.setLeftView();
      })
    );

    elNavigation.append(
      this.createToolIcon(Potree.resourcePath + '/icons/right.svg', '[title]tt.right_view_control', () => {
        this.viewer.setRightView();
      })
    );

    elNavigation.append(
      this.createToolIcon(Potree.resourcePath + '/icons/front.svg', '[title]tt.front_view_control', () => {
        this.viewer.setFrontView();
      })
    );

    elNavigation.append(
      this.createToolIcon(Potree.resourcePath + '/icons/back.svg', '[title]tt.back_view_control', () => {
        this.viewer.setBackView();
      })
    );

    elNavigation.append(
      this.createToolIcon(Potree.resourcePath + '/icons/top.svg', '[title]tt.top_view_control', () => {
        this.viewer.setTopView();
      })
    );

    elNavigation.append(
      this.createToolIcon(Potree.resourcePath + '/icons/bottom.svg', '[title]tt.bottom_view_control', () => {
    ...
    let cameraMode = Object.keys(CameraMode).filter((key) => CameraMode[key] === this.viewer.scene.cameraMode);
