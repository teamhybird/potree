...
"use strict";
  ...
  function createTexture(img) {
    ...
    texture.mapping = import_three.EquirectangularReflectionMapping;
    return texture;
  }
...
void main() {
  ...
  var Renderer = class extends AbstractService {
    ...
    constructor(viewer) {
      ...
      this.meshContainer = this.viewer.meshContainer || new import_three8.Group();
  ...
  var Viewer = class extends TypedEventTarget {
     ...
     */
    getZoomLevel() {
      return import_three12.MathUtils.clamp(this.config.maxFov - this.camera.fov, 0, 100);
    }
    /**
